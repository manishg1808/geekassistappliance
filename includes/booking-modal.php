...
<div class="modal-overlay" id="booking-modal">
    <div class="modal-container">
        ...
        <div style="text-align: center; margin-bottom: 1.5rem;">
            ...
            <h3 style="font-size: 1.5rem;" class="text-gradient">Start Certified Online Technical Session</h3>
            <p style="color: var(--text-muted); font-size: 0.875rem;">Get instant online screen-share, guided virtual diagnostics & tech assistance.</p>
        </div>

        <form id="booking-form-modal">
            <div class="form-group">
                <label class="form-label">Support Type / Session Mode *</label>
                <select name="support_type" class="form-control" required style="font-weight: 700; border-color: var(--primary);">
                    <option value="online_session" selected>🌐 Certified Online Technical Session (Instant Screen Share / Video Guided Fix)</option>
            ...
            <div class="form-group">
                ...
                <select name="service" class="form-control" id="modal-service-select" required>
                    <option value="">Select Service Needed...</option>
                    <option value="online-tech-help">🌐 Certified Online Tech & Printer Help</option>
            ...
            <div class="form-group">
                ...
                <input type="text" name="address" class="form-control" placeholder="Street Address, Kamloops, BC" required>
            </div>

            <div class="form-group">
                <label class="form-label">Describe Issue / Appliance Brand</label>
                <textarea name="issue" class="form-control" rows="3" placeholder="e.g. Samsung refrigerator making loud clicking sound and leaking water..."></textarea>
            </div>
