...
<section style="padding: 4rem 0 3rem; background: radial-gradient(circle at 50% 0%, #eff6ff 0%, #f8fafc 100%); border-bottom: 1px solid var(--border-light);">
    <div class="container" style="text-align: center; max-width: 800px;">
        ...
        <p style="color: var(--text-muted); font-size: 1rem; line-height: 1.7;">
            These Terms & Conditions govern your access to and use of GeekAssist Appliance services, including 100% online remote diagnostic evaluations, screen-share technical support, and resolution guarantees.
        </p>
    </div>
</section>
        ...
        <div class="glass-card" style="padding: 2.5rem; background: #ffffff; border-radius: var(--radius-md); border: 1px solid var(--border-light); display: flex; flex-direction: column; gap: 2rem;">
            ...
            <div>
                <h2 style="font-size: 1.4rem; color: var(--text-main); font-weight: 800; margin-bottom: 0.75rem; display: flex; align-items: center; gap: 0.5rem;">
                    <i class="ri-checkbox-circle-fill" style="color: var(--primary);"></i> 1. Acceptance of Terms & Remote Authorization
                </h2>
                <p style="color: var(--text-muted); font-size: 0.95rem; line-height: 1.7;">
                    By submitting a quick support request form or authorizing a remote screen-share connection with a GeekAssist Appliance technician, you agree to be bound by these Terms & Conditions. You confirm that you are the owner or authorized user of the equipment (appliance, printer, or computer system) being serviced.
                </p>
            </div>

            <div style="border-top: 1px solid var(--border-light); padding-top: 1.5rem;">
                <h2 style="font-size: 1.4rem; color: var(--text-main); font-weight: 800; margin-bottom: 0.75rem; display: flex; align-items: center; gap: 0.5rem;">
                    <i class="ri-remote-control-line" style="color: var(--accent);"></i> 2. Remote Diagnostic & Technical Scope
                </h2>
                <p style="color: var(--text-muted); font-size: 0.95rem; line-height: 1.7;">
                    Our service model is 100% online and remote. Diagnostics and technical repairs are conducted via encrypted screen-share or live video assistance. While over 90% of technical faults (software bugs, driver crashes, network printer offline errors, and control panel fault codes) are resolved online, physical hardware breakage (such as cracked compressor seals or fried mainboards) may require component replacement beyond remote scope.
                </p>
            </div>
            ...
            <div style="border-top: 1px solid var(--border-light); padding-top: 1.5rem;">
                ...
                <p style="color: var(--text-muted); font-size: 0.95rem; line-height: 1.7;">
                    GeekAssist Appliance will exercise reasonable technical care in performing remote diagnostic services. In no event shall GeekAssist Appliance be liable for pre-existing hardware failures, unauthorized software modifications by third parties, or internet connection interruptions beyond our control.
                </p>
            </div>
